...
public class UebaMlScheduler implements ScheduledJobParameter {
    ...
    public UebaMlScheduler(String id, Boolean enabled, Instant lastUpdateTime, Instant enabledTime, Schedule schedule, Long seqNo, Long primaryTerm) {
        this.id = id;
    ...
    public static UebaMlScheduler parse(XContentParser xcp, String id, Long seqNo, Long primaryTerm) throws IOException {
        if (id == null) {
            id = NO_ID;
        }
        ...
        return new UebaMlScheduler(id, enabled, lastUpdateTime, enabledTime, schedule, seqNo, primaryTerm);
    }
    ...
    public boolean equals(Object o) {
        ...
        UebaMlScheduler uebaMlScheduler = (UebaMlScheduler) o;
        return Objects.equals(id, uebaMlScheduler.id) && Objects.equals(enabled, uebaMlScheduler.enabled) && Objects.equals(lastUpdateTime, uebaMlScheduler.lastUpdateTime) && Objects.equals(enabledTime, uebaMlScheduler.enabledTime) && Objects.equals(schedule, uebaMlScheduler.schedule);
    }
