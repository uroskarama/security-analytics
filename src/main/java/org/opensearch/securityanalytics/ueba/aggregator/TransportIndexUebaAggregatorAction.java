...
public class TransportIndexUebaAggregatorAction extends HandledTransportAction<IndexUebaAggregatorRequest, IndexUebaAggregatorResponse> implements SecureTransportAction {
    ...
    private void createMonitorFromQueries(String index, List<Pair<String, Rule>> rulesById, Detector detector, ActionListener<List<IndexMonitorResponse>> listener, RefreshPolicy refreshPolicy) throws SigmaError, IOException {
    ...
    private void updateMonitorFromQueries(String index, List<Pair<String, Rule>> rulesById, Detector detector, ActionListener<List<IndexMonitorResponse>> listener, RefreshPolicy refreshPolicy) throws SigmaError, IOException {
    ...
    private IndexMonitorRequest createDocLevelMonitorRequest(Pair<String, List<Pair<String, Rule>>> logIndexToQueries, Detector detector, RefreshPolicy refreshPolicy, String monitorId, Method restMethod) {
        ...
        Monitor monitor = new Monitor(monitorId, Monitor.NO_VERSION, detector.getName(), detector.getEnabled(), detector.getSchedule(), detector.getLastUpdateTime(), detector.getEnabledTime(),
            MonitorType.DOC_LEVEL_MONITOR, detector.getUser(), 1, docLevelMonitorInputs, triggers, Map.of(),
    ...
    private List<IndexMonitorRequest> buildBucketLevelMonitorRequests(Pair<String, List<Pair<String, Rule>>> logIndexToQueries, Detector detector, RefreshPolicy refreshPolicy, String monitorId, Method restMethod) throws IOException, SigmaError {
     ...
     */
    private void deleteAlertingMonitors(List<String> monitorIds, RefreshPolicy refreshPolicy, ActionListener<List<DeleteMonitorResponse>> listener){
    ...
    private void deleteAlertingMonitor(String monitorId, RefreshPolicy refreshPolicy, ActionListener<DeleteMonitorResponse> listener) {
    ...
    class AsyncIndexDetectorsAction {
        ...
        void start() {
            try {
                ...
                TransportIndexUebaAggregatorAction.this.threadPool.getThreadContext().stashContext();
...
/*                        if (!checkUserPermissionsWithResource(
                                ...
                                "detector",
                                detector.getId(),
                                TransportIndexUebaAggregatorAction.this.filterByEnabled
                        )
