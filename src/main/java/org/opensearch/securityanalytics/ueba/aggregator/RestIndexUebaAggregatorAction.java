...
public class RestIndexUebaAggregatorAction extends BaseRestHandler {
    ...
    protected RestChannelConsumer prepareRequest(RestRequest request, NodeClient client) throws IOException {
        ...
        return channel -> client.execute(IndexUebaAggregatorAction.INSTANCE, indexUebaAggregatorRequest, indexUebaAggregatorResponse(channel, request.method()));
    }

    private RestResponseListener<IndexUebaAggregatorResponse> indexUebaAggregatorResponse(RestChannel channel, RestRequest.Method restMethod) {
